    ...
    def __init__(
        ...
        **kwargs
        ...
        self.toggle_nav_rail_button = IconButton(
            icon=icons.ARROW_CIRCLE_LEFT,icon_color=colors.BLUE_GREY_600, selected=False,
    ...
    def hydrate_all_boards_view(self):
        self.all_boards_view.controls[-1] = Row([
            Container(
                content=Row([
                    Container(
                        content=Text(value=b.board_name), data=b, expand=True, on_click=self.board_click),
                    Container(
